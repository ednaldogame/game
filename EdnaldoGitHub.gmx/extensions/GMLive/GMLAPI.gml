...
// Generated at 2018-08-08 19:39:29 (13888ms) for v1.4.1804+
...
globalvar f___lnc__lf6;f___lnc__lf6=asset_get_index("__lnc__lf6");
...
gml_func_add("ds_list_set(id,pos,value)",f___lnc__lf6);
var l_gmlFuncs="";
var l_gmlVars="";
l_gmlFuncs=("0=is_bool(val)#:"+chr(13)+chr(10)
	...
	+"1092=draw_texture_flush()"+chr(13)+chr(10)
	+"1093=draw_flush()"+chr(13)+chr(10)
	+"1094=shop_leave_rating(text_string,yes_string,no_string,url)"+chr(13)+chr(10)
	+"1095=url_get_domain():"+chr(13)+chr(10)
	+"1096=url_open(url)"+chr(13)+chr(10)
	+"1097=url_open_ext(url,target)"+chr(13)+chr(10)
	+"1098=url_open_full(url,target,options)"+chr(13)+chr(10)
	+"1099=get_timer():"+chr(13)+chr(10)
	+"1100=device_get_tilt_x():"+chr(13)+chr(10)
	+"1101=device_get_tilt_y():"+chr(13)+chr(10)
	+"1102=device_get_tilt_z():"+chr(13)+chr(10)
	+"1103=device_is_keypad_open():"+chr(13)+chr(10)
	+"1104=device_mouse_check_button(:index,:index):"+chr(13)+chr(10)
	+"1105=device_mouse_check_button_pressed(:index,:index):"+chr(13)+chr(10)
	+"1106=device_mouse_check_button_released(:index,:index):"+chr(13)+chr(10)
	+"1107=device_mouse_x(:index):"+chr(13)+chr(10)
	+"1108=device_mouse_y(:index):"+chr(13)+chr(10)
	+"1109=device_mouse_raw_x(:index):"+chr(13)+chr(10)
	+"1110=device_mouse_raw_y(:index):"+chr(13)+chr(10)
	+"1111=device_mouse_x_to_gui(:index):"+chr(13)+chr(10)
	+"1112=device_mouse_y_to_gui(:index):"+chr(13)+chr(10)
	+"1113=gamepad_is_supported():"+chr(13)+chr(10)
	+"1114=gamepad_get_device_count():"+chr(13)+chr(10)
	+"1115=gamepad_is_connected(device):"+chr(13)+chr(10)
	+"1116=gamepad_get_description(device):"+chr(13)+chr(10)
	+"1117=gamepad_get_button_threshold(device):"+chr(13)+chr(10)
	+"1118=gamepad_set_button_threshold(device, threshold)"+chr(13)+chr(10)
	+"1119=gamepad_get_axis_deadzone(device):"+chr(13)+chr(10)
	+"1120=gamepad_set_axis_deadzone(device, deadzone)"+chr(13)+chr(10)
	+"1121=gamepad_button_count(device:index):"+chr(13)+chr(10)
	+"1122=gamepad_button_check(device:index, buttonIndex:index):"+chr(13)+chr(10)
	+"1123=gamepad_button_check_pressed(device:index, buttonIndex:index):"+chr(13)+chr(10)
	+"1124=gamepad_button_check_released(device:index, buttonIndex:index):"+chr(13)+chr(10)
	+"1125=gamepad_button_value(device:index, buttonIndex:index):"+chr(13)+chr(10)
	+"1126=gamepad_axis_count(axis:index):"+chr(13)+chr(10)
	+"1127=gamepad_axis_value(device:index, axisIndex:index):"+chr(13)+chr(10)
	+"1128=gamepad_set_vibration(device, leftMotorSpeed, rightMotorSpeed)"+chr(13)+chr(10)
	+"1129=gamepad_set_color(index,color)"+chr(13)+chr(10)
	+"1130=gamepad_set_colour(index,colour)"+chr(13)+chr(10)
	+"1130=gamepad_set_color(index,colour)"+chr(13)+chr(10)
	+"1131=os_is_paused():"+chr(13)+chr(10)
	+"1132=window_has_focus():"+chr(13)+chr(10)
	+"1133=code_is_compiled():"+chr(13)+chr(10)
	+"1134=http_get(url):"+chr(13)+chr(10)
	+"1135=http_get_file(url, dest):"+chr(13)+chr(10)
	+"1136=http_post_string(:string,:string):"+chr(13)+chr(10)
	+"1137=http_request(url:string, method, header_map, body):"+chr(13)+chr(10)
	+"1138=json_encode(map:index):"+chr(13)+chr(10)
	+"1139=json_decode(:string):"+chr(13)+chr(10)
	+"1140=zip_unzip(file, destPath)"+chr(13)+chr(10)
	+"1141=base64_encode(:string):"+chr(13)+chr(10)
	+"1142=base64_decode(:string):"+chr(13)+chr(10)
	+"1143=md5_string_unicode(:string):"+chr(13)+chr(10)
	+"1144=md5_string_utf8(:string):"+chr(13)+chr(10)
	+"1145=md5_file(:string):"+chr(13)+chr(10)
	+"1146=os_is_network_connected():"+chr(13)+chr(10)
	+"1147=sha1_string_unicode(:string):"+chr(13)+chr(10)
	+"1148=sha1_string_utf8(:string):"+chr(13)+chr(10)
	+"1149=sha1_file(:string):"+chr(13)+chr(10)
	+"1150=os_powersave_enable(enable)"+chr(13)+chr(10)
	+"1151=physics_world_create(PixelToMetreScale):"+chr(13)+chr(10)
	+"1152=physics_world_gravity(gx, gy)"+chr(13)+chr(10)
	+"1153=physics_world_update_speed(speed)"+chr(13)+chr(10)
	+"1154=physics_world_update_iterations(iterations)"+chr(13)+chr(10)
	+"1155=physics_world_draw_debug(draw_flags)"+chr(13)+chr(10)
	+"1156=physics_pause_enable(pause)"+chr(13)+chr(10)
	+"1157=physics_fixture_create():"+chr(13)+chr(10)
	+"1158=physics_fixture_set_kinematic(fixture)"+chr(13)+chr(10)
	+"1159=physics_fixture_set_density(fixture, density)"+chr(13)+chr(10)
	+"1160=physics_fixture_set_awake(fixture, flag)"+chr(13)+chr(10)
	+"1161=physics_fixture_set_restitution(fixture, restitution)"+chr(13)+chr(10)
	+"1162=physics_fixture_set_friction(fixture,friction)"+chr(13)+chr(10)
	+"1163=physics_fixture_set_collision_group(fixture, group)"+chr(13)+chr(10)
	+"1164=physics_fixture_set_sensor(fixture, sensorState)"+chr(13)+chr(10)
	+"1165=physics_fixture_set_linear_damping(fixture, damping)"+chr(13)+chr(10)
	+"1166=physics_fixture_set_angular_damping(fixture, damping)"+chr(13)+chr(10)
	+"1167=physics_fixture_set_circle_shape(fixture, circleRadius)"+chr(13)+chr(10)
	+"1168=physics_fixture_set_box_shape(fixture, halfWidth, halfHeight)"+chr(13)+chr(10)
	+"1169=physics_fixture_set_edge_shape(fixture, local_x1, local_y1, local_x2, local_y2)"+chr(13)+chr(10)
	+"1170=physics_fixture_set_polygon_shape(fixture)"+chr(13)+chr(10)
	+"1171=physics_fixture_set_chain_shape(fixture, loop)"+chr(13)+chr(10)
	+"1172=physics_fixture_add_point(fixture, local_x, local_y)"+chr(13)+chr(10)
	+"1173=:physics_fixture_bind(fixture, obj)"+chr(13)+chr(10)
	+"1174=:physics_fixture_bind_ext(fixture, obj, xo, yo)"+chr(13)+chr(10)
	+"1175=physics_fixture_delete(fixture)"+chr(13)+chr(10)
	+"1176=:physics_apply_force(xpos, ypos, xforce, yforce)"+chr(13)+chr(10)
	+"1177=:physics_apply_impulse(xpos, ypos, ximpulse, yimpulse)"+chr(13)+chr(10)
	+"1178=:physics_apply_angular_impulse(impulse)"+chr(13)+chr(10)
	+"1179=:physics_apply_local_force(xlocal, ylocal, xforce_local, yforce_local)"+chr(13)+chr(10)
	+"1180=:physics_apply_local_impulse(xlocal, ylocal, ximpulse_local, yimpulse_local)"+chr(13)+chr(10)
	+"1181=:physics_apply_torque(torque)"+chr(13)+chr(10)
	+"1182=:physics_mass_properties(mass, local_centre_of_mass_x, local_centre_of_mass_y, inertia)"+chr(13)+chr(10)
	+"1183=:physics_draw_debug()"+chr(13)+chr(10)
	+"1184=:physics_test_overlap(x, y, angle, obj)"+chr(13)+chr(10)
	+"1185=physics_remove_fixture(inst, id)"+chr(13)+chr(10)
	+"1186=:physics_set_friction(fixture, friction)"+chr(13)+chr(10)
	+"1187=:physics_set_density(fixture, density)"+chr(13)+chr(10)
	+"1188=:physics_set_restitution(fixture, restitution)"+chr(13)+chr(10)
	+"1189=:physics_get_friction(fixture):"+chr(13)+chr(10)
	+"1190=:physics_get_density(fixture):"+chr(13)+chr(10)
	+"1191=:physics_get_restitution(fixture):"+chr(13)+chr(10)
	+"1192=physics_joint_distance_create(inst1, inst2, anchor_1_x, anchor_1_y, anchor_2_x, anchor_2_y, collideInstances):"+chr(13)+chr(10)
	+"1193=physics_joint_rope_create(inst1, inst2, anchor_1_x, anchor_1_y, anchor_2_x, anchor_2_y, maxLength, collideInstances):"+chr(13)+chr(10)
	+"1194=physics_joint_revolute_create(inst1, inst2, anchor_x, anchor_y, lower_angle_limit, upper_angle_limit, enable_limit, max_motor_torque, motor_speed, enable_motor, collideInstances):"+chr(13)+chr(10)
	+"1195=physics_joint_prismatic_create(inst1, inst2, anchor_x, anchor_y, axis_x, axis_y, lower_translation_limit, upper_translation_limit, enable_limit, max_motor_force, motor_speed, enable_motor, collideInstances):"+chr(13)+chr(10)
	+"1196=physics_joint_pulley_create(inst1, inst2, anchor_1_x, anchor_1_y, anchor_2_x, anchor_2_y, local_anchor_1_x, local_anchor_1_y, local_anchor_2_x, local_anchor_2_y, ratio, collideInstances):"+chr(13)+chr(10)
	+"1197=physics_joint_wheel_create(inst1, inst2, anchor_x, anchor_y, axis_x, axis_y, enableMotor, max_motor_torque, motor_speed, freq_hz, damping_ratio, collideInstances):"+chr(13)+chr(10)
	+"1198=physics_joint_weld_create(inst1, inst2, anchor_x, anchor_y, ref_angle, freq_hz, damping_ratio, collideInstances):"+chr(13)+chr(10)
	+"1199=physics_joint_friction_create(inst1, inst2, anchor_x, anchor_y, max_force, max_torque, collideInstances):"+chr(13)+chr(10)
	+"1200=physics_joint_gear_create(inst1, inst2, revoluteJoint, prismaticJoint, ratio):"+chr(13)+chr(10)
	+"1201=physics_joint_enable_motor(joint, motorState)"+chr(13)+chr(10)
	+"1202=physics_joint_get_value(joint, field):"+chr(13)+chr(10)
	+"1203=physics_joint_set_value(joint, field, value)"+chr(13)+chr(10)
	+"1204=physics_joint_delete(joint)"+chr(13)+chr(10)
	+"1205=physics_particle_create(typeflags, x, y, xv, yv, col, alpha, category):"+chr(13)+chr(10)
	+"1206=physics_particle_delete(ind)"+chr(13)+chr(10)
	+"1207=physics_particle_delete_region_circle(x, y, radius)"+chr(13)+chr(10)
	+"1208=physics_particle_delete_region_box(x, y, halfWidth, halfHeight)"+chr(13)+chr(10)
	+"1209=physics_particle_delete_region_poly(pointList)"+chr(13)+chr(10)
	+"1210=physics_particle_set_flags(ind, typeflags)"+chr(13)+chr(10)
	+"1211=physics_particle_set_category_flags(category, typeflags)"+chr(13)+chr(10)
	+"1212=physics_particle_draw(typemask, category, sprite, subimg)"+chr(13)+chr(10)
	+"1213=physics_particle_draw_ext(typemask, category, sprite, subimg, xscale, yscale, angle, col, alpha)"+chr(13)+chr(10)
	+"1214=physics_particle_count()"+chr(13)+chr(10)
	+"1215=physics_particle_get_data(buffer, dataFlags):"+chr(13)+chr(10)
	+"1216=physics_particle_get_data_particle(ind, buffer, dataFlags):"+chr(13)+chr(10)
	+"1217=physics_particle_group_begin(typeflags, groupflags, x, y, ang, xv, yv, angVelocity, col, alpha, strength, category)"+chr(13)+chr(10)
	+"1218=physics_particle_group_circle(radius)"+chr(13)+chr(10)
	+"1219=physics_particle_group_box(halfWidth, halfHeight)"+chr(13)+chr(10)
	+"1220=physics_particle_group_polygon()"+chr(13)+chr(10)
	+"1221=physics_particle_group_add_point(x, y)"+chr(13)+chr(10)
	+"1222=physics_particle_group_end()"+chr(13)+chr(10)
	+"1223=physics_particle_group_join(to, from)"+chr(13)+chr(10)
	+"1224=physics_particle_group_delete(ind)"+chr(13)+chr(10)
	+"1225=physics_particle_group_count(group)"+chr(13)+chr(10)
	+"1226=physics_particle_group_get_data(group, buffer, dataFlags):"+chr(13)+chr(10)
	+"1227=physics_particle_group_get_mass(group):"+chr(13)+chr(10)
	+"1228=physics_particle_group_get_inertia(group):"+chr(13)+chr(10)
	+"1229=physics_particle_group_get_centre_x(group):"+chr(13)+chr(10)
	+"1230=physics_particle_group_get_centre_y(group):"+chr(13)+chr(10)
	+"1231=physics_particle_group_get_vel_x(group):"+chr(13)+chr(10)
	+"1232=physics_particle_group_get_vel_y(group):"+chr(13)+chr(10)
	+"1233=physics_particle_group_get_ang_vel(group):"+chr(13)+chr(10)
	+"1234=physics_particle_group_get_x(group):"+chr(13)+chr(10)
	+"1235=physics_particle_group_get_y(group):"+chr(13)+chr(10)
	+"1236=physics_particle_group_get_angle(group):"+chr(13)+chr(10)
	+"1237=physics_particle_set_group_flags(group, groupflags)"+chr(13)+chr(10)
	+"1238=physics_particle_get_group_flags(group):"+chr(13)+chr(10)
	+"1239=physics_particle_get_max_count():"+chr(13)+chr(10)
	+"1240=physics_particle_get_radius():"+chr(13)+chr(10)
	+"1241=physics_particle_get_density():"+chr(13)+chr(10)
	+"1242=physics_particle_get_damping():"+chr(13)+chr(10)
	+"1243=physics_particle_get_gravity_scale():"+chr(13)+chr(10)
	+"1244=physics_particle_set_max_count(count)"+chr(13)+chr(10)
	+"1245=physics_particle_set_radius(radius)"+chr(13)+chr(10)
	+"1246=physics_particle_set_density(density)"+chr(13)+chr(10)
	+"1247=physics_particle_set_damping(damping)"+chr(13)+chr(10)
	+"1248=physics_particle_set_gravity_scale(scale)"+chr(13)+chr(10)
	+"1249=network_create_socket(type):"+chr(13)+chr(10)
	+"1250=network_create_socket_ext(type, port):"+chr(13)+chr(10)
	+"1251=network_create_server(type, port, maxclients):"+chr(13)+chr(10)
	+"1252=network_create_server_raw(type, port, maxclients):"+chr(13)+chr(10)
	+"1253=network_connect(socket, url, port)"+chr(13)+chr(10)
	+"1254=network_connect_raw(socket, url, port)"+chr(13)+chr(10)
	+"1255=network_send_packet(socket, bufferid, size)"+chr(13)+chr(10)
	+"1256=network_send_raw(socket, buffer_id, size)"+chr(13)+chr(10)
	+"1257=network_send_broadcast(socket, port, bufferid, size)"+chr(13)+chr(10)
	+"1258=network_send_udp(socket, URL, port, data, size)"+chr(13)+chr(10)
	+"1259=network_send_udp_raw(socket, URL, port, data, size)"+chr(13)+chr(10)
	+"1260=network_set_timeout(socket, read, write)"+chr(13)+chr(10)
	+"1261=network_set_config(parameter, value)"+chr(13)+chr(10)
	+"1262=network_resolve(url)"+chr(13)+chr(10)
	+"1263=network_destroy(socket)"+chr(13)+chr(10)
	+"1264=buffer_create(size, buffer_type, alignment):"+chr(13)+chr(10)
	+"1265=buffer_write(buffer, type, value)"+chr(13)+chr(10)
	+"1266=buffer_read(buffer, type):"+chr(13)+chr(10)
	+"1267=buffer_seek(buffer, base, offset)"+chr(13)+chr(10)
	+"1268=buffer_get_surface(buffer, surface, mode, offset, modulo):"+chr(13)+chr(10)
	+"1269=buffer_set_surface(buffer, surface, mode, offset, modulo)"+chr(13)+chr(10)
	+"1270=buffer_delete(buffer)"+chr(13)+chr(10)
	+"1271=buffer_exists(buffer):"+chr(13)+chr(10)
	+"1272=buffer_get_type(buffer):"+chr(13)+chr(10)
	+"1273=buffer_get_alignment(buffer):"+chr(13)+chr(10)
	+"1274=buffer_poke(buffer, offset, type, value)"+chr(13)+chr(10)
	+"1275=buffer_peek(:buffer, offset:int, type:index):"+chr(13)+chr(10)
	+"1276=buffer_save(buffer, filename)"+chr(13)+chr(10)
	+"1277=buffer_save_ext(buffer, filename, offset, size)"+chr(13)+chr(10)
	+"1278=buffer_load(filename):"+chr(13)+chr(10)
	+"1279=buffer_load_ext(buffer, filename, offset):"+chr(13)+chr(10)
	+"1280=buffer_load_partial(buffer, filename, src_offset, src_len, dest_offset):"+chr(13)+chr(10)
	+"1281=buffer_copy(src_buffer, src_offset, size, dest_buffer, dest_offset)"+chr(13)+chr(10)
	+"1282=buffer_fill(buffer, offset, type, value, size)"+chr(13)+chr(10)
	+"1283=buffer_get_size(buffer):"+chr(13)+chr(10)
	+"1284=buffer_tell(:buffer):"+chr(13)+chr(10)
	+"1285=buffer_resize(buffer, newsize)"+chr(13)+chr(10)
	+"1286=buffer_md5(:buffer, offset:int, size:int):"+chr(13)+chr(10)
	+"1287=buffer_sha1(:buffer, offset:int, size:int):"+chr(13)+chr(10)
	+"1288=buffer_base64_encode(:buffer, offset:int, size:int):"+chr(13)+chr(10)
	+"1289=buffer_base64_decode(:string):"+chr(13)+chr(10)
	+"1290=buffer_base64_decode_ext(:buffer, :string, offset:int):"+chr(13)+chr(10)
	+"1291=buffer_sizeof(type:index):"+chr(13)+chr(10)
	+"1292=buffer_get_address(buffer):"+chr(13)+chr(10)
	+"1293=buffer_create_from_vertex_buffer(vertex_buffer, type, alignment):"+chr(13)+chr(10)
	+"1294=buffer_create_from_vertex_buffer_ext(vertex_buffer, type, alignment, start_vertex, num_vertices):"+chr(13)+chr(10)
	+"1295=buffer_copy_from_vertex_buffer(vertex_buffer, start_vertex, num_vertices, dest_buffer, dest_offset)"+chr(13)+chr(10)
	+"1296=buffer_async_group_begin(groupname)"+chr(13)+chr(10)
	+"1297=buffer_async_group_option(optionname,optionvalue)"+chr(13)+chr(10)
	+"1298=buffer_async_group_end()"+chr(13)+chr(10)
	+"1299=buffer_load_async(bufferid,filename,offset,size):"+chr(13)+chr(10)
	+"1300=buffer_save_async(bufferid,filename,offset,size)"+chr(13)+chr(10)
	+"1301=gml_release_mode(enable)"+chr(13)+chr(10)
	+"1302=steam_activate_overlay(overlayIndex)"+chr(13)+chr(10)
	+"1303=steam_is_overlay_enabled():"+chr(13)+chr(10)
	+"1304=steam_is_overlay_activated():"+chr(13)+chr(10)
	+"1305=steam_get_persona_name():"+chr(13)+chr(10)
	+"1306=steam_initialised():"+chr(13)+chr(10)
	+"1307=steam_is_cloud_enabled_for_app():"+chr(13)+chr(10)
	+"1308=steam_is_cloud_enabled_for_account():"+chr(13)+chr(10)
	+"1309=steam_file_persisted(:string):"+chr(13)+chr(10)
	+"1310=steam_get_quota_total():"+chr(13)+chr(10)
	+"1311=steam_get_quota_free():"+chr(13)+chr(10)
	+"1312=steam_file_write(:string, data, :number):"+chr(13)+chr(10)
	+"1313=steam_file_write_file(:string, :string):"+chr(13)+chr(10)
	+"1314=steam_file_read(filename):"+chr(13)+chr(10)
	+"1315=steam_file_delete(filename)"+chr(13)+chr(10)
	+"1316=steam_file_exists(filename):"+chr(13)+chr(10)
	+"1317=steam_file_size(filename):"+chr(13)+chr(10)
	+"1318=steam_file_share(filename)"+chr(13)+chr(10)
	+"1319=steam_publish_workshop_file(filename, previewImage,title,description)"+chr(13)+chr(10)
	+"1320=steam_is_screenshot_requested():"+chr(13)+chr(10)
	+"1321=steam_send_screenshot(filename,width,height)"+chr(13)+chr(10)
	+"1322=steam_is_user_logged_on():"+chr(13)+chr(10)
	+"1323=steam_get_user_steam_id():"+chr(13)+chr(10)
	+"1324=steam_user_owns_dlc(_id):"+chr(13)+chr(10)
	+"1325=steam_user_installed_dlc(_id):"+chr(13)+chr(10)
	+"1326=steam_set_achievement(ach_name)"+chr(13)+chr(10)
	+"1327=steam_get_achievement(ach_name):"+chr(13)+chr(10)
	+"1328=steam_clear_achievement(ach_name)"+chr(13)+chr(10)
	+"1329=steam_set_stat_int(stat_name,value)"+chr(13)+chr(10)
	+"1330=steam_set_stat_float(stat_name,value)"+chr(13)+chr(10)
	+"1331=steam_set_stat_avg_rate(stat_name,session_count,session_length)"+chr(13)+chr(10)
	+"1332=steam_get_stat_int(stat_name):"+chr(13)+chr(10)
	+"1333=steam_get_stat_float(stat_name):"+chr(13)+chr(10)
	+"1334=steam_get_stat_avg_rate(stat_name):"+chr(13)+chr(10)
	+"1335=steam_reset_all_stats()"+chr(13)+chr(10)
	+"1336=steam_reset_all_stats_achievements()"+chr(13)+chr(10)
	+"1337=steam_stats_ready():"+chr(13)+chr(10)
	+"1338=steam_create_leaderboard(lb_name,sort_method,display_type):"+chr(13)+chr(10)
	+"1339=steam_upload_score(:string, :number):"+chr(13)+chr(10)
	+"1340=steam_upload_score_ext(:string, :number, :bool):"+chr(13)+chr(10)
	+"1341=steam_download_scores_around_user(lb_name,range_start,range_end):"+chr(13)+chr(10)
	+"1342=steam_download_scores(lb_name,start_idx,end_idx):"+chr(13)+chr(10)
	+"1343=steam_download_friends_scores(lb_name):"+chr(13)+chr(10)
	+"1344=steam_upload_score_buffer(lb_name, score, buffer_id):"+chr(13)+chr(10)
	+"1345=steam_upload_score_buffer_ext(lb_name, score, buffer_id, forceupdate):"+chr(13)+chr(10)
	+"1346=steam_current_game_language():"+chr(13)+chr(10)
	+"1347=steam_available_languages():"+chr(13)+chr(10)
	+"1348=steam_activate_overlay_browser(url)"+chr(13)+chr(10)
	+"1349=steam_activate_overlay_user(dialog_name, steamid)"+chr(13)+chr(10)
	+"1350=steam_activate_overlay_store(app_id)"+chr(13)+chr(10)
	+"1351=steam_get_user_persona_name(steam_id):"+chr(13)+chr(10)
	+"1352=steam_get_app_id():"+chr(13)+chr(10)
	+"1353=steam_get_user_account_id():"+chr(13)+chr(10)
	+"1354=steam_ugc_download(ugc_handle, dest_filename):"+chr(13)+chr(10)
	+"1355=steam_ugc_create_item(consumer_app_id, file_type):"+chr(13)+chr(10)
	+"1356=steam_ugc_start_item_update(consumer_app_id, published_file_id)"+chr(13)+chr(10)
	+"1357=steam_ugc_set_item_title(ugc_update_handle, title)"+chr(13)+chr(10)
	+"1358=steam_ugc_set_item_description(ugc_update_handle, description)"+chr(13)+chr(10)
	+"1359=steam_ugc_set_item_visibility(ugc_update_handle, visibility)"+chr(13)+chr(10)
	+"1360=steam_ugc_set_item_tags(ugc_update_handle, tag_array)"+chr(13)+chr(10)
	+"1361=steam_ugc_set_item_content(ugc_update_handle, directory)"+chr(13)+chr(10)
	+"1362=steam_ugc_set_item_preview(ugc_update_handle, image_path)"+chr(13)+chr(10)
	+"1363=steam_ugc_submit_item_update(ugc_update_handle, change_note):"+chr(13)+chr(10)
	+"1364=steam_ugc_get_item_update_progress(ugc_update_handle, info_map):"+chr(13)+chr(10)
	+"1365=steam_ugc_subscribe_item(published_file_id):"+chr(13)+chr(10)
	+"1366=steam_ugc_unsubscribe_item(published_file_id):"+chr(13)+chr(10)
	+"1367=steam_ugc_num_subscribed_items():"+chr(13)+chr(10)
	+"1368=steam_ugc_get_subscribed_items(item_list):"+chr(13)+chr(10)
	+"1369=steam_ugc_get_item_install_info(published_file_id, info_map):"+chr(13)+chr(10)
	+"1370=steam_ugc_get_item_update_info(published_file_id, info_map):"+chr(13)+chr(10)
	+"1371=steam_ugc_request_item_details(published_file_id, max_age_seconds):"+chr(13)+chr(10)
	+"1372=steam_ugc_create_query_user(list_type, match_type, sort_order, page):"+chr(13)+chr(10)
	+"1373=steam_ugc_create_query_user_ex(list_type, match_type, sort_order, page, account_id, creator_app_id, consumer_app_id):"+chr(13)+chr(10)
	+"1374=steam_ugc_create_query_all(query_type, match_type, page):"+chr(13)+chr(10)
	+"1375=steam_ugc_create_query_all_ex(query_type, match_type, page, creator_app_id, consumer_app_id):"+chr(13)+chr(10)
	+"1376=steam_ugc_query_set_cloud_filename_filter(ugc_query_handle , match_cloud_filename):"+chr(13)+chr(10)
	+"1377=steam_ugc_query_set_match_any_tag(ugc_query_handle, match_any_tag)"+chr(13)+chr(10)
	+"1378=steam_ugc_query_set_search_text(ugc_query_handle, search_text)"+chr(13)+chr(10)
	+"1379=steam_ugc_query_set_ranked_by_trend_days(ugc_query_handle , days)"+chr(13)+chr(10)
	+"1380=steam_ugc_query_add_required_tag(ugc_query_handle, tag_name)"+chr(13)+chr(10)
	+"1381=steam_ugc_query_add_excluded_tag(ugc_query_handle, tag_name)"+chr(13)+chr(10)
	+"1382=steam_ugc_query_set_return_long_description(ugc_query_handle, return_long_desc)"+chr(13)+chr(10)
	+"1383=steam_ugc_query_set_return_total_only(ugc_query_handle, return_total_only)"+chr(13)+chr(10)
	+"1384=steam_ugc_query_set_allow_cached_response(ugc_query_handle, max_age_seconds)"+chr(13)+chr(10)
	+"1385=steam_ugc_send_query(ugc_query_handle)"+chr(13)+chr(10)
	+"1386=shader_set(shader)"+chr(13)+chr(10)
	+"1387=shader_reset()"+chr(13)+chr(10)
	+"1388=shader_current():"+chr(13)+chr(10)
	+"1389=shader_is_compiled(shader):"+chr(13)+chr(10)
	+"1390=shader_get_sampler_index(shader,uniform_name):"+chr(13)+chr(10)
	+"1391=shader_get_uniform(shader,uniform_name):"+chr(13)+chr(10)
	+"1392=shader_set_uniform_i(uniform_id,val,....)"+chr(13)+chr(10)
	+"1393=shader_set_uniform_i_array(uniform_id,array)"+chr(13)+chr(10)
	+"1394=shader_set_uniform_f(uniform_id,val,....)"+chr(13)+chr(10)
	+"1395=shader_set_uniform_f_array(uniform_id,array)"+chr(13)+chr(10)
	+"1396=shader_set_uniform_matrix(uniform_id)"+chr(13)+chr(10)
	+"1397=shader_set_uniform_matrix_array(uniform_id,array)"+chr(13)+chr(10)
	+"1398=shader_enable_corner_id(enable)"+chr(13)+chr(10)
	+"1399=texture_set_stage(sampled_id, texture_id)"+chr(13)+chr(10)
	+"1400=texture_get_texel_width(texture_id):"+chr(13)+chr(10)
	+"1401=texture_get_texel_height(texture_id):"+chr(13)+chr(10)
	+"1402=shaders_are_supported():"+chr(13)+chr(10)
	+"1403=vertex_format_begin()"+chr(13)+chr(10)
	+"1404=vertex_format_end():"+chr(13)+chr(10)
	+"1405=vertex_format_delete(format_id)"+chr(13)+chr(10)
	+"1406=vertex_format_add_position()"+chr(13)+chr(10)
	+"1407=vertex_format_add_position_3d()"+chr(13)+chr(10)
	+"1408=vertex_format_add_colour()"+chr(13)+chr(10)
	+"1408=vertex_format_add_color()"+chr(13)+chr(10)
	+"1409=vertex_format_add_normal()"+chr(13)+chr(10)
	+"1410=vertex_format_add_textcoord()"+chr(13)+chr(10)
	+"1411=vertex_format_add_custom(type,usage)"+chr(13)+chr(10)
	+"1412=vertex_create_buffer():"+chr(13)+chr(10)
	+"1413=vertex_create_buffer_ext(size):"+chr(13)+chr(10)
	+"1414=vertex_delete_buffer(vbuff)"+chr(13)+chr(10)
	+"1415=vertex_begin(vbuff,format)"+chr(13)+chr(10)
	+"1416=vertex_end(vbuff)"+chr(13)+chr(10)
	+"1417=vertex_position(vbuff,x,y)"+chr(13)+chr(10)
	+"1418=vertex_position_3d(vbuff,x,y,z)"+chr(13)+chr(10)
	+"1419=vertex_colour(vbuff,colour,alpha)"+chr(13)+chr(10)
	+"1419=vertex_color(vbuff,colour,alpha)"+chr(13)+chr(10)
	+"1420=vertex_argb(vbuff,argb)"+chr(13)+chr(10)
	+"1421=vertex_texcoord(vbuff,u,v)"+chr(13)+chr(10)
	+"1422=vertex_normal(vbuff,nx,ny,nz)"+chr(13)+chr(10)
	+"1423=vertex_float1(vbuff,f1)"+chr(13)+chr(10)
	+"1424=vertex_float2(vbuff,f1,f2)"+chr(13)+chr(10)
	+"1425=vertex_float3(vbuff,f1,f2,f3)"+chr(13)+chr(10)
	+"1426=vertex_float4(vbuff,f1,f2,f3,f4)"+chr(13)+chr(10)
	+"1427=vertex_ubyte4(vbuff,b1,b2,b3,b4)"+chr(13)+chr(10)
	+"1428=vertex_submit(vbuff,prim,texture)"+chr(13)+chr(10)
	+"1429=vertex_freeze(vbuff)"+chr(13)+chr(10)
	+"1430=vertex_get_number(vbuff):"+chr(13)+chr(10)
	+"1431=vertex_get_buffer_size(vbuff):"+chr(13)+chr(10)
	+"1432=vertex_create_buffer_from_buffer(src_buffer,format):"+chr(13)+chr(10)
	+"1433=vertex_create_buffer_from_buffer_ext(src_buffer,format,src_offset,num_vertices):"+chr(13)+chr(10)
	+"1434=:skeleton_animation_set(anim_name)"+chr(13)+chr(10)
	+"1435=:skeleton_animation_get():"+chr(13)+chr(10)
	+"1436=:skeleton_animation_mix(anim_from,anim_to,duration)"+chr(13)+chr(10)
	+"1437=:skeleton_animation_set_ext(anim_name, track)"+chr(13)+chr(10)
	+"1438=:skeleton_animation_get_ext(track):"+chr(13)+chr(10)
	+"1439=:skeleton_animation_get_duration(anim_name):"+chr(13)+chr(10)
	+"1440=:skeleton_animation_get_frames(anim_name):"+chr(13)+chr(10)
	+"1441=:skeleton_animation_clear(track)"+chr(13)+chr(10)
	+"1442=:skeleton_skin_set(skin_name)"+chr(13)+chr(10)
	+"1443=:skeleton_skin_get():"+chr(13)+chr(10)
	+"1444=:skeleton_attachment_set(slot, attachment)"+chr(13)+chr(10)
	+"1445=:skeleton_attachment_get(slot):"+chr(13)+chr(10)
	+"1446=:skeleton_attachment_create(name,sprite,ind,xo,yo,xs,ys,rot):"+chr(13)+chr(10)
	+"1447=:skeleton_collision_draw_set(val)"+chr(13)+chr(10)
	+"1448=:skeleton_bone_data_get(bone, map):"+chr(13)+chr(10)
	+"1449=:skeleton_bone_data_set(bone, map)"+chr(13)+chr(10)
	+"1450=:skeleton_bone_state_get(bone, map):"+chr(13)+chr(10)
	+"1451=:skeleton_bone_state_set(bone, map)"+chr(13)+chr(10)
	+"1452=:skeleton_animation_get_frame(track):"+chr(13)+chr(10)
	+"1453=:skeleton_animation_set_frame(track,index)"+chr(13)+chr(10)
	+"1454=:skeleton_get_minmax():"+chr(13)+chr(10)
	+"1455=:skeleton_get_num_bounds():"+chr(13)+chr(10)
	+"1456=:skeleton_get_bounds(index):"+chr(13)+chr(10)
	+"1457=draw_skeleton(sprite,animname,skinname,frame,x,y,xscale,yscale,rot,colour,alpha)"+chr(13)+chr(10)
	+"1458=draw_skeleton_time(sprite, animname,skinname, time, x,y, xscale,yscale, rot, colour,alpha)"+chr(13)+chr(10)
	+"1459=draw_skeleton_instance(instance,animname,skinname,frame,x,y,xscale,yscale,rot,colour,alpha)"+chr(13)+chr(10)
	+"1460=draw_skeleton_collision(sprite,animname,frame,x,y,xscale,yscale,rot,colour)"+chr(13)+chr(10)
	+"1461=skeleton_animation_list(sprite, list)"+chr(13)+chr(10)
	+"1462=skeleton_skin_list(sprite, list)"+chr(13)+chr(10)
	+"1463=skeleton_slot_data(sprite, list)");
l_gmlVars=("1464=gravity"+chr(13)+chr(10)
	+"1465=gravity_direction"+chr(13)+chr(10)
	+"1466=instance_count*"+chr(13)+chr(10)
	+"1467=instance_id*"+chr(13)+chr(10)
	+"1468=room_speed"+chr(13)+chr(10)
	+"1469=fps*"+chr(13)+chr(10)
	+"1470=fps_real*"+chr(13)+chr(10)
	+"1471=current_time*"+chr(13)+chr(10)
	+"1472=current_year*"+chr(13)+chr(10)
	+"1473=current_month*"+chr(13)+chr(10)
	+"1474=current_day*"+chr(13)+chr(10)
	+"1475=current_weekday*"+chr(13)+chr(10)
	+"1476=current_hour*"+chr(13)+chr(10)
	+"1477=current_minute*"+chr(13)+chr(10)
	+"1478=current_second*"+chr(13)+chr(10)
	+"1479=room*"+chr(13)+chr(10)
	+"1480=room_first*"+chr(13)+chr(10)
	+"1481=room_last*"+chr(13)+chr(10)
	+"1482=room_width*"+chr(13)+chr(10)
	+"1483=room_height*"+chr(13)+chr(10)
	+"1484=room_caption"+chr(13)+chr(10)
	+"1485=room_persistent"+chr(13)+chr(10)
	+"1486=score"+chr(13)+chr(10)
	+"1487=lives"+chr(13)+chr(10)
	+"1488=health"+chr(13)+chr(10)
	+"1489=event_type*"+chr(13)+chr(10)
	+"1490=event_number*"+chr(13)+chr(10)
	+"1491=event_object*"+chr(13)+chr(10)
	+"1492=event_action*"+chr(13)+chr(10)
	+"1493=application_surface*"+chr(13)+chr(10)
	+"1494=debug_mode*"+chr(13)+chr(10)
	+"1495=keyboard_key"+chr(13)+chr(10)
	+"1496=keyboard_lastkey"+chr(13)+chr(10)
	+"1497=keyboard_lastchar"+chr(13)+chr(10)
	+"1498=keyboard_string"+chr(13)+chr(10)
	+"1499=mouse_x*"+chr(13)+chr(10)
	+"1500=mouse_y*"+chr(13)+chr(10)
	+"1501=mouse_button"+chr(13)+chr(10)
	+"1502=mouse_lastbutton"+chr(13)+chr(10)
	+"1503=cursor_sprite"+chr(13)+chr(10)
	+"1504=background_colour"+chr(13)+chr(10)
	+"1505=background_showcolour"+chr(13)+chr(10)
	+"1506=background_visible[]"+chr(13)+chr(10)
	+"1507=background_foreground[]"+chr(13)+chr(10)
	+"1508=background_index[]"+chr(13)+chr(10)
	+"1509=background_x[]"+chr(13)+chr(10)
	+"1510=background_y[]"+chr(13)+chr(10)
	+"1511=background_width[]*"+chr(13)+chr(10)
	+"1512=background_height[]*"+chr(13)+chr(10)
	+"1513=background_htiled[]"+chr(13)+chr(10)
	+"1514=background_vtiled[]"+chr(13)+chr(10)
	+"1515=background_xscale[]"+chr(13)+chr(10)
	+"1516=background_yscale[]"+chr(13)+chr(10)
	+"1517=background_hspeed[]"+chr(13)+chr(10)
	+"1518=background_vspeed[]"+chr(13)+chr(10)
	+"1519=background_blend[]"+chr(13)+chr(10)
	+"1520=background_alpha[]"+chr(13)+chr(10)
	+"1521=view_enabled"+chr(13)+chr(10)
	+"1522=view_current*"+chr(13)+chr(10)
	+"1523=view_visible[]"+chr(13)+chr(10)
	+"1524=view_xview[]"+chr(13)+chr(10)
	+"1525=view_yview[]"+chr(13)+chr(10)
	+"1526=view_wview[]"+chr(13)+chr(10)
	+"1527=view_hview[]"+chr(13)+chr(10)
	+"1528=view_xport[]"+chr(13)+chr(10)
	+"1529=view_yport[]"+chr(13)+chr(10)
	+"1530=view_wport[]"+chr(13)+chr(10)
	+"1531=view_hport[]"+chr(13)+chr(10)
	+"1532=view_angle[]"+chr(13)+chr(10)
	+"1533=view_hborder[]"+chr(13)+chr(10)
	+"1534=view_vborder[]"+chr(13)+chr(10)
	+"1535=view_hspeed[]"+chr(13)+chr(10)
	+"1536=view_vspeed[]"+chr(13)+chr(10)
	+"1537=view_object[]"+chr(13)+chr(10)
	+"1538=view_surface_id[]"+chr(13)+chr(10)
	+"1539=game_id*"+chr(13)+chr(10)
	+"1540=game_display_name*"+chr(13)+chr(10)
	+"1541=game_project_name*"+chr(13)+chr(10)
	+"1542=game_save_id*"+chr(13)+chr(10)
	+"1543=working_directory*"+chr(13)+chr(10)
	+"1544=temp_directory*"+chr(13)+chr(10)
	+"1545=program_directory*"+chr(13)+chr(10)
	+"1546=browser_width*"+chr(13)+chr(10)
	+"1547=browser_height*"+chr(13)+chr(10)
	+"1548=os_type*"+chr(13)+chr(10)
	+"1549=os_device*"+chr(13)+chr(10)
	+"1550=os_browser*"+chr(13)+chr(10)
	+"1551=os_version*"+chr(13)+chr(10)
	+"1552=display_aa*"+chr(13)+chr(10)
	+"1553=async_load*"+chr(13)+chr(10)
	+"1554=delta_time*"+chr(13)+chr(10)
	+"1555=webgl_enabled*");
...
#define __lnc__lf5
/// __lnc__lf5(...m:dynamic)
if (live_enabled) {
	var l_setting=argument[0];
}

#define __lnc__lf6
/// __lnc__lf6(...m:dynamic)
if (live_enabled) {
...
#define __lnc__f1464
/// __lnc__f1464(...args:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
		gravity = argument[1];
		return undefined;
...
#define __lnc__f1465
/// __lnc__f1465(...args:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1466
/// __lnc__f1466()->dynamic
if (live_enabled) {
	return instance_count;
} else return undefined;

#define __lnc__f1467
/// __lnc__f1467()->dynamic
if (live_enabled) {
	return instance_id;
} else return undefined;

#define __lnc__f1468
/// __lnc__f1468(...args:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1484
/// __lnc__f1484(...args:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1485
/// __lnc__f1485(...args:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1486
/// __lnc__f1486(...args:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
		score = argument[1];
		return undefined;
...
#define __lnc__f1487
/// __lnc__f1487(...args:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
		lives = argument[1];
		return undefined;
...
#define __lnc__f1488
/// __lnc__f1488(...args:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
		health = argument[1];
		return undefined;
...
#define __lnc__f1489
/// __lnc__f1489()->dynamic
if (live_enabled) {
	return event_type;
} else return undefined;

#define __lnc__f1490
/// __lnc__f1490()->dynamic
if (live_enabled) {
	return event_number;
} else return undefined;

#define __lnc__f1491
/// __lnc__f1491()->dynamic
if (live_enabled) {
	return event_object;
} else return undefined;
...
#define __lnc__f1495
/// __lnc__f1495(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1496
/// __lnc__f1496(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1497
/// __lnc__f1497(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1498
/// __lnc__f1498(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1499
/// __lnc__f1499()->dynamic
if (live_enabled) {
	return mouse_x;
} else return undefined;

#define __lnc__f1500
/// __lnc__f1500()->dynamic
if (live_enabled) {
	return mouse_y;
} else return undefined;

#define __lnc__f1501
/// __lnc__f1501(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1502
/// __lnc__f1502(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1503
/// __lnc__f1503(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1504
/// __lnc__f1504(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1505
/// __lnc__f1505(...args1:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1506
/// __lnc__f1506(...args1:dynamic)->dynamic
if (live_enabled) {
...
#define __lnc__f1507
/// __lnc__f1507(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1508
/// __lnc__f1508(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1509
/// __lnc__f1509(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1510
/// __lnc__f1510(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0...7]"));
	if(argument[0]){
...
#define __lnc__f1511
/// __lnc__f1511(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0...7]"));
...
#define __lnc__f1512
/// __lnc__f1512(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0...7]"));
...
#define __lnc__f1513
/// __lnc__f1513(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1514
/// __lnc__f1514(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1515
/// __lnc__f1515(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1516
/// __lnc__f1516(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1517
/// __lnc__f1517(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1518
/// __lnc__f1518(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1519
/// __lnc__f1519(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1520
/// __lnc__f1520(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1521
/// __lnc__f1521(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1522
/// __lnc__f1522()->dynamic
if (live_enabled) {
	return view_current;
} else return undefined;

#define __lnc__f1523
/// __lnc__f1523(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1524
/// __lnc__f1524(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1525
/// __lnc__f1525(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1526
/// __lnc__f1526(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1527
/// __lnc__f1527(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1528
/// __lnc__f1528(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1529
/// __lnc__f1529(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1530
/// __lnc__f1530(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1531
/// __lnc__f1531(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1532
/// __lnc__f1532(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1533
/// __lnc__f1533(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1534
/// __lnc__f1534(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1535
/// __lnc__f1535(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1536
/// __lnc__f1536(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1537
/// __lnc__f1537(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1538
/// __lnc__f1538(...args5:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1539
/// __lnc__f1539()->dynamic
if (live_enabled) {
	return game_id;
} else return undefined;

#define __lnc__f1540
/// __lnc__f1540()->dynamic
if (live_enabled) {
	return game_display_name;
} else return undefined;

#define __lnc__f1541
/// __lnc__f1541()->dynamic
if (live_enabled) {
