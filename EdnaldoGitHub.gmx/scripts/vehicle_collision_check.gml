/// vehicle_collision_check(COL_?, ARGUMENTS);
 ...
 // Main sensor:
    ...
    // Test collision:
       var colTest;
       colTest = vehicle_collision(floor(argument1), floor(argument2), collision_layer);
 ...
 // Slope sensor:
    ...
    // Test collision:    
       var colTest;
       colTest = vehicle_collision(floor(argument2 + dsin(argument4)*23),
 ...
 // Top sensor:
    ...
    // Test collision:         
       var colTest;
       colTest = vehicle_collision(floor(argument2 - dsin(argument4)*11),
 ...
 // Left sensor:
    ...
    // Test collision:       
       var colTest;
       colTest = vehicle_collision(floor(argument2 - dcos(argument4)*11),
 ...
 // Left sensor (Edge):
    ...
    // Test collision:                                                 
       var colTest;
       colTest = vehicle_collision(floor(argument1 - dcos(argument3)* 8 + dsin(argument3)*11),
 ...
 // Left sensor (Limiter):
    ...
    // Test collision:                                                 
       var colTest;
       colTest = vehicle_collision(tempOffsetX, tempOffsetY, par_solid)
